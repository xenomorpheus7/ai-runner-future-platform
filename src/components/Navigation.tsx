            ...
            {navLinks.map((link) => (
              link.path === "/projects" ? (
                <div key={link.path} className="relative group">
                  ...
                  <div className="absolute top-full pt-2 inline-block rounded-md border border-primary/30 bg-background/95 shadow-lg hidden group-hover:block">
                    <Link
                      to="/blog"
                      className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary whitespace-nowrap"
                    >
                      {t("nav.blog")}
                    </Link>
                  </div>
                ...
                <div key={link.path} className="relative group">
                  ...
                  <div className="absolute left-0 top-full pt-2 inline-block rounded-md border border-primary/30 bg-background/95 shadow-lg hidden group-hover:block">
                    <Link
                      to="/schools"
                      className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary whitespace-nowrap"
                    >
